  ...
  return (
    <AdminShell active="customers" adminName={admin.name} adminRole={admin.role}>
      ...
      <p className="adm-lead">
        Creates the customer&apos;s account and a personal access link. They open the
        link, enter this mobile number and choose their own password — you never see or
        set it. Loan and UPI details are added when you create a loan.
      </p>
